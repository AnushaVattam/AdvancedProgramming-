...
Stack<StackElementT>::Stack(int maxSz)
{
 ...
 */
template <typename StackElementT>
void Stack<StackElementT>::push(StackElementT element)
{
  if (isFull()) {
...
template <typename StackElementT>
StackElementT Stack<StackElementT>::pop()
{
  if (isEmpty()) {
...
template <typename StackElementT>
bool Stack<StackElementT>::isEmpty() const
{
  return top < 0;
}

template <typename StackElementT>
bool Stack<StackElementT>::isFull() const
{
